                            ...
                            <div class="row margin-top product-layout_width">
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="single-product.php"><img class="img-responsive"  src="images/img16.jpg" width="200" height="200"></a></div>
                                        <div>
                                            <div class="caption">
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="single-product.php"><img class="img-responsive"  src="images/img17.jpg" width="200" height="200" ></a></div>
                                        <div>
                                            <div class="caption">
                                                ...
                                                <p>
                                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry....</p>
                                                <p class="price">
                                                    <span class="new_price"><i class="fa fa-inr"></i>81.00</span> 
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="single-product.php"><img class="img-responsive"  src="images/img4.jpg" width="200" height="200" ></a></div>
                                        <div>
                                            <div class="caption">
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        ...
                                        <div>
                                            <div class="caption">
                                                <h4 class="product_title"><a href="single-product.php">Officiis phaedrum</a></h4>
                                                <p>
                                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.... </p>
                                                <p class="price">
                                                    <span class="new_price"><i class="fa fa-inr"></i>26.00</span> 
                                                    <span class="old_price"><i class="fa fa-inr"></i>34.00</span>
                                                    <span class="price-tax">Ex Tax: <i class="fa fa-inr"></i>21.00</span>
                                                </p>
                                            </div>
                                            <!--<div class="button-group">!-->
                                            <a class="btn book-btn btn-default reg_button" href="cart.php">BUY NOW!</a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        <div class="image"><a href="single-product.php"><img class="img-responsive"  src="images/d23.jpg" width="200" height="200"></a></div>
                                        <div>
                                            <div class="caption">
                                                <h4 class="product_title"><a href="single-product.php">Lorem ipsum dolor</a></h4>
                                                <p>
                                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry....</p>
                                                <p class="price">
                                                    <span class="new_price"><i class="fa fa-inr"></i>199.00</span> 

                                                    <span class="price-tax">Ex Tax: <i class="fa fa-inr"></i>180.00</span>
                                                </p>
                                            </div>
                                            <!--<div class="button-group">!-->

                                            <a class="btn book-btn book-btn btn-default reg_button" href="cart.php">BUY NOW!</a>
                                ...
                                <div class="product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="product-thumb">
                                        ...
                                        <div>
                                            <div class="caption">
                                                <h4 class="product_title"><a href="single-product.php">Cicero famously</a></h4>
                                                <p>
                                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry.... </p>
                                                <p class="price">
                                                    <span class="new_price"><i class="fa fa-inr"></i>171.00</span> 

                                                    <span class="price-tax">Ex Tax: <i class="fa fa-inr"></i>162.00</span>
                                                </p>
                                            </div>
                                            <!--<div class="button-group">!-->
                                            <a class="btn book-btn btn-default reg_button" href="cart.php">BUY NOW!</a>
