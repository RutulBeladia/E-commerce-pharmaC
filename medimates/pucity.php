            ...
            <div class="row">
              <div class="col-md-6">
                <?php
                  ...
                  {
                    $id=$_GET['did'];
                    $q=mysqli_query($cn,"select * from tblcity where ID='$id'");
              ...
              <div class="col-md-3">
               ...
               <div class="col-md-3">
                <div>
                  <input type="text" class="form-control" value="<?php echo $ans['City']; ?>" placeholder="enter state" name="city">
                </div>  
              </div>
              <div class="col-md-2">
                <div>
              ...
              <?php
                ...
                else
                {
                  ...
                  {
                    $id=$_GET['did'];
                    $up=mysqli_query($cn,"update tblcity set Country='$cntry',State='$state',City='$city' where ID='$id'");
                    if($up)
                    {
                      echo "<script>alert('record updated');window.location='city.php'</script>";
                    }
                    else
                    {
                  ...
                  {
                    echo "<script>alert('check connection');window.location='city.php'</script>";
                  }
                }
