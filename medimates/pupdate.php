            ...
            <div class="row">
              <div class="col-md-6">
                <?php
                  ...
                  {
                    $id=$_GET['did'];
                    $q=mysqli_query($cn,"select * from tblcountry where ID='$id'");
              ...
              <?php
                ...
                else
                {
                  ...
                  {
                    $id=$_GET['did'];
                    $up=mysqli_query($cn,"update tblcountry set Country='$cntry' where ID='$id'");
                    if($up)
                    {
                      echo "<script>alert('record updated');window.location='country.php'</script>";
                    }
                    else
                    {
                      echo "<script>alert('mysqli_error($cn);');window.location='country.php'</script>";
                    }
                  }
                  else
                  {
                    echo "<script>alert('check connection');window.location='country.php'</script>";
                  }
                }
