...
<div class="contentText container-fluid">
        <div class="row margin-top product-layout_width">
                ...
                $q=mysqli_query($con,"select * from product where sub_category='Diabetes Devices'");
                    ...
                    <div class="product-thumb-height">
                        <div class="product-thumb transition" style="width: 100%">
                            <ul>
                                ...
                                <div class="caption"style="padding-top:50px;">
                                        <p>
...
<a href="addtocart.php?action=addtocart&&prodcut_id=<?php echo $result['product_id'];?>&&qty=1&&selling_price=<?php echo $result['selling_price'];?>" class="btn btn-default text-bold" style="width:250px;">Add to cart</a>
        ...
        <div class="container">
        <h3>Daibetes Dieat</h3>
    </div>
<div class="contentText container-fluid">
        <div class="row margin-top product-layout_width">
                <?php 
                $con=mysqli_connect('localhost','root','','medimates');
                $q=mysqli_query($con,"select * from product where sub_category='dieat'");
                while ($result=mysqli_fetch_assoc($q))
                {
                ?>
                <form  method="post" action="">
...
<div class="container">
        <h3>Daibetes Medicine</h3>
    </div>
<div class="contentText container-fluid">
        <div class="row margin-top product-layout_width">
                <?php 
                $con=mysqli_connect('localhost','root','','medimates');
                $q=mysqli_query($con,"select * from product where sub_category='medicine'");
                while ($result=mysqli_fetch_assoc($q))
                {
                ?>
                <form  method="post" action="">
